                <div class="page-header">
                    <div class="page-header-left d-flex align-items-center">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Ship Pembelian </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <form id="project-details" novalidate="novalidate">
                                            <fieldset>
                                                ...
                                                <div class="mb-5">
                                                    <h2 class="fs-16 fw-bold">Form Ship Pembelian</h2>
                                                    <p class="text-muted">Lengkapi isian pada Form Ship Pembelian dibawah ini.</p>
                                                </div> 
                                                <fieldset>    
                                                    <div class="mb-4">
                                                        <label for="projectName" class="form-label">Nomor Ship</label>
                                                        <input type="text" class="form-control" id="nopol" name="nopol">
                                                    </div>
                                                    <div class="mb-4">
                                                        <label for="projectName" class="form-label">Nama Ship</label>
                                                    ...
                                                    <div class="mb-4">
                                                        <label for="projectName" class="form-label">Kota</label>
                                                        <input type="text" class="form-control" id="amt1" name="nopol">
                                                    </div>                
                                                </fieldset>
                                            </fieldset>
