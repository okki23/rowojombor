                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="<?php echo base_url('employee'); ?>">Employee</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="<?php echo base_url('user'); ?>">User</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="<?php echo base_url('report_so'); ?>">Report SO</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="<?php echo base_url('report_po'); ?>">Report PO</a></li>
                        </ul>
                    </li> 
                </ul>
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0">Administrator <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                        <span class="fs-12 fw-medium text-muted">administrator@outlook.com</span>
                                    </div>
                                </div>
                            </div> 
